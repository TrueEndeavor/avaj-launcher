...
**4 aircrafts, 4 different reactions:**

- **B1** (Balloon): 
    - Foating at sea level (height 21)
    - Fights RAIN → SUN → FOG → SNOW
    - critical condition after 4 cycles (final height 2)

- **H4** (Helicopter):
    - Starts too low (height 3) in SNOW
    - crashes immediately in Cycle 1

- **J1** (JetPlane):
    - Cruising at low-altitude (height 10)
    - Navigates FOG and SNOW, recovers in SUN, 
    - Survives and finally at a safe altitude (height 7)

- **H1** (Helicopter):
    - Lucky aircraft, happily hovering in SUN finally at the same height 8
